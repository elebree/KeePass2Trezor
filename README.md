...
> [!NOTE]
> ```Trezor Safe 7``` is **not supported yet**. It communicates exclusively over the Trezor Host Protocol (THP), which replaces the legacy wire protocol this plugin uses.
